...
class contentController extends ModulesFrontControllers
{
	public $view;
	public $view_search;
    ...
    public function frontShowRequest($param)
    {
...
switch ($ContentController->view_search) {
	case 'show':
		$ContentController->frontViewInit($ContentController->params);
		break;
}